    ...
    <div className="space-y-4">
      ...
      {loading ? (
        ...
        <div className="border rounded-card p-8 text-center">
          <p className="text-sm text-gray-700">No opportunity gaps detected yet.</p>
          <p className="text-xs text-gray-500 mt-1">Insights will appear here when search trends and social signals align.</p>
        </div>
      ) : (
        <div className="space-y-3">
                ...
                <div className="flex-1">
                  ...
                  <div className="flex gap-2 mt-2">
                    {insight.our_gsc_position ? (
                      <span className="inline-block border rounded px-2 py-1 text-xs bg-yellow-50">
                        Position: {Math.round(insight.our_gsc_position)}
                      </span>
                    ) : (
                      <span className="inline-block border rounded px-2 py-1 text-xs bg-gray-50">
                        Not ranking
                      </span>
                    )}
